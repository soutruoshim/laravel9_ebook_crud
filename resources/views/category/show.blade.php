                    ...
                    <div class="card-body"><h5 class="card-title"></h5>
                        <form method="POST" action="{{ route('categories.update', $category->id ) }}">
                            ...
                            @csrf
                                ...
                                <input name="name" id="name" placeholder="" type="text" value="{{$category->name}}" class="form-control">
                            </div>
                            <div class="position-relative form-group">
                                <label class="">Slug</label>
                                <input name="slug" id="slug" placeholder="" type="text" value="{{$category->slug}}" class="form-control">
                            </div>
